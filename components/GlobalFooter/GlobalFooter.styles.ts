...
export const stanfordMenu = 'list-unstyled mb-10 sm:mb-4 mr-19 sm:mr-0 p-0 text-15 md:text-16 2xl:text-17 flex flex-col sm:flex-row';
export const legalMenu = 'list-unstyled mb-10 sm:mb-0 ml-19 sm:ml-0 p-0 text-15 sm:text-14 md:text-15 xl:text-15 flex flex-col sm:flex-row sm:link-regular';
