...
export const stanfordMenu = 'list-unstyled mb-10 sm:mb-4 mr-19 sm:mr-0 p-0 text-12 md:text-13 2xl:text-14 flex flex-col sm:flex-row';
export const legalMenu = 'list-unstyled mb-10 sm:mb-0 ml-19 sm:ml-0 p-0 text-12 sm:text-13 md:text-13 xl:text-13 flex flex-col sm:flex-row sm:link-regular';
