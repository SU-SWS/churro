...
export async function POST(request: NextRequest) {
  try {
    ...
    // Try samlify first with debugging
    console.log('🔍 Attempting samlify parsing...')
    ...
    try {
      ...
      console.log('✅ samlify succeeded!')
      console.log('📋 Extracted data:', JSON.stringify(extract, null, 2))

      // If we get here, samlify worked - use its data
      ...
      console.error('❌ samlify failed:', samlifyError)
